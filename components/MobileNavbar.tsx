...
const MobileNavbar = () => {
    ...
    return (
        <div className="w-full px-1 py-6 top-0 z-50 sticky glassmorphism lg:hidden backdrop-blur-sm">
...
export default MobileNavbar; // Ensure MobileNavbar is the default export